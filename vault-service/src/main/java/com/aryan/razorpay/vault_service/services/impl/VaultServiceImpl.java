package com.aryan.razorpay.vault_service.services.impl;
...
import com.aryan.razorpay.common_lib.enums.CardBrand;
...
import com.aryan.razorpay.vault_service.config.VaultEncryptionConfig;
...
import com.aryan.razorpay.vault_service.entities.CardToken;
import com.aryan.razorpay.vault_service.entities.VaultCard;
import com.aryan.razorpay.vault_service.processor.CardPaymentProcessor;
import com.aryan.razorpay.vault_service.repository.CardTokenRepository;
import com.aryan.razorpay.vault_service.repository.VaultCardRepository;
import com.aryan.razorpay.vault_service.services.VaultService;
...
public class VaultServiceImpl implements VaultService {
    ...
    public TokenizeResponse tokenize(TokenizeRequest request, UUID merchantId) {
        ...
        String token = "tok_"+ RandomizedUtil.randomBase64(32);
